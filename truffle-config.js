 ...
 */
 ...
 const ganachePort = process.env.ganachePort;
 const ganacheNetworkId = process.env.ganacheNetworkId;
 ...
 module.exports = {
   ...
   networks: {
     ...
     development: {
      ...
      network_id: ganacheNetworkId,       // Any network (default: none)
     },
